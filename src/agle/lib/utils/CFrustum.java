...
///////////////////////////////// CFRUSTUM \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
/////
/////	Questa classe serve a definire, trovare il volume definito dal 
/////	campo visivo della telecamera, esso e' definito da 6 piani che 
/////	si intersecano definendo una specie di tronco di piramide
/////
///////////////////////////////// CFRUSTUM \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
public class CFrustum 
{
	...
	static final int RIGHT	= 0;		// The RIGHT side of the frustum
	static final int LEFT	= 1;		// The LEFT	 side of the frustum
	static final int BOTTOM	= 2;		// The BOTTOM side of the frustum
	static final int TOP	= 3;		// The TOP side of the frustum
	static final int BACK	= 4;		// The BACK	side of the frustum
	static final int FRONT	= 5;		// The FRONT side of the frustum

	// Like above, instead of saying a number for the ABC and D of the plane, we
	// want to be more descriptive.
	static final int A = 0;				// The X value of the plane's normal
	static final int B = 1;				// The Y value of the plane's normal
	static final int C = 2;				// The Z value of the plane's normal
	static final int D = 3;				// The distance the plane is from the origin
	...
	/////
	///////////////////////////////// CALCULATE FRUSTUM \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
	public void CalculateFrustum(GLFunc gl, GLUFunc glu)
	{    
